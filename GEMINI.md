...
- **Product Requirements Document (`PRD.md`)**: Create a clear, readable `PRD.md` in the task subfolder detailing goal, functional requirements, input/output specifications, and edge cases.
...
- **Subfolder Index (`INDEX.md`)**: Maintain an `INDEX.md` file in each task directory that maps and links all components (`PRD.md`, `main.py`, `test_main.py`, `TEST_CASES.md`) for instant navigation and context retrieval.
